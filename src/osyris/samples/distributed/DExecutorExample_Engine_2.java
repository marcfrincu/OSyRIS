 ...
 * This executor handles the tasks of the second engine
 * @author Marc Frincu
 * @since 2010
 *
 */
public class DExecutorExample_Engine_2 extends Executor {

	CommunicationAMQPEngine com = null;
	
	public DExecutorExample_Engine_2(State state, Logger log) {
		super(state, log);
	...
	protected void execute() throws Exception {
		...
		if (type != null && destination != null && type.compareTo("true") == 0) {
			...
			if (proc.compareTo("isprime") == 0) {
				...
				sb.append(this.state.getInput("i1").toString());
				sb.append("#");
				sb.append(Boolean.valueOf(isPrime).toString());
